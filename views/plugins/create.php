...
<form action="" method="POST">
    ...
    <input type="hidden" name="wpdeployer[action]" value="install-plugin">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    <p class="description">Example: wpdeployer/wpdeployer-plugin</p>
                </td>
            </tr>
            <tr>
                <th scope="row">
            ...
            <tr>
                ...
                <td>
                    <select name="wpdeployer[type]">
                        <option value="gh" <?php if (isset($_POST['wpdeployer']['type']) && $_POST['wpdeployer']['type'] === 'gh') echo 'selected="selected" '; ?>>GitHub</option>
                        <option value="bb" <?php if (isset($_POST['wpdeployer']['type']) && $_POST['wpdeployer']['type'] === 'bb') echo 'selected="selected" '; ?>>Bitbucket</option>
                        <option value="gl" <?php if (isset($_POST['wpdeployer']['type']) && $_POST['wpdeployer']['type'] === 'gl') echo 'selected="selected" '; ?>>GitLab</option>
                    </select>
                </td>
            </tr>
            <tr>
                <th scope="row"></th>
                <td>
                    <label><input type="checkbox" name="wpdeployer[private]" <?php if (isset($_POST['wpdeployer']['private'])) echo 'checked'; ?>> Repository is private</label>
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td>
                    <label><input type="checkbox" name="wpdeployer[ptd]" <?php if (isset($_POST['wpdeployer']['ptd'])) echo 'checked'; ?>> Push-to-Deploy</label>
            ...
            <tr>
                <th scope="row"></th>
                <td>
                    <label><input type="checkbox" name="wpdeployer[dry-run]" <?php if (isset($_POST['wpdeployer']['dry-run'])) echo 'checked'; ?>> Dry run</label>
